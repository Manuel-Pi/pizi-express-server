...
const getLogger = (prefix = "", options = {}) => {
    ...
    if (conf.filename && conf.enabled !== false) {
        ...
        if (!openFiles[conf.filename])
            openFiles[conf.filename] = fs.createWriteStream(path.join(logDir, conf.filename), { flags: 'a' });
...
//# sourceMappingURL=default-server-libs.js.map